...
public partial class ExtendedInspector
{
    ...
    private void RigidBodyField(KeyValuePair<Component, List<InspectorInfo>> componentInspector)
    {
        ...
        component.GetComponent<Rigidbody>().mass = EditorGUILayout.FloatField("Mass", component.GetComponent<Rigidbody>().mass);
        component.GetComponent<Rigidbody>().drag = EditorGUILayout.FloatField("Drag", component.GetComponent<Rigidbody>().drag);
        component.GetComponent<Rigidbody>().angularDrag = EditorGUILayout.FloatField("Angular Drag", component.GetComponent<Rigidbody>().angularDrag);
        component.GetComponent<Rigidbody>().useGravity = EditorGUILayout.Toggle("Use Gravity", component.GetComponent<Rigidbody>().useGravity);
        component.GetComponent<Rigidbody>().isKinematic = EditorGUILayout.Toggle("Is Kinematic", component.GetComponent<Rigidbody>().isKinematic);
        component.GetComponent<Rigidbody>().interpolation = (RigidbodyInterpolation)EditorGUILayout.EnumPopup("Interpolate", component.GetComponent<Rigidbody>().interpolation);
        component.GetComponent<Rigidbody>().collisionDetectionMode = (CollisionDetectionMode)EditorGUILayout.EnumPopup("Collision Detection", component.GetComponent<Rigidbody>().collisionDetectionMode);

        _isConstraint = EditorGUILayout.Foldout(_isConstraint, "Constraints");
        if (_isConstraint)
        {
            // horrible code
            var constaints = component.GetComponent<Rigidbody>().constraints;
            ...
            component.GetComponent<Rigidbody>().constraints = (RigidbodyConstraints)newC;
        }
        BeginHorizontal();
        if (GUILayout.Button("Apply to Selection", EditorStyles.miniButtonLeft))
        {
